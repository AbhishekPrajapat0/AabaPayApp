...
class KycApi {
  ...
  Future<dynamic> getKycStatus() async {
    ...
    // print("ApiService Request- ${AppConstants.KYC_STATUS} - $request");

    var response = await client.post(
        Uri.parse(AppConstants.ENV_DEV_URL + AppConstants.KYC_STATUS),
        headers: {
    ...
    // print(
    //     "ApiService Response - ${AppConstants.KYC_STATUS} - ${response.body}");
